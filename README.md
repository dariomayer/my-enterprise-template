...
Questo è un boilerplate enterprise-grade strutturato come monorepo utilizzando `pnpm workspaces`. È stato progettato specificamente seguendo i principi di **massima modularità** e **scalabilità**, permettendo di gestire progetti di qualsiasi dimensione e complessità mantenendo il codice pulito e separato.
